...
Route::get('/food/{id}/edit', [FoodController::class, 'edit'])->name('foods.edit');
Route::post('/food/{id}/update', [FoodController::class, 'update'])->name('foods.update');
Route::get('food/{id}/destroy', [FoodController::class, 'destroy'])->name('foods.destroy');
